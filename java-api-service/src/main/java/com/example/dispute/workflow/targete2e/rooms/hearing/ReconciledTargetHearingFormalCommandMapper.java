...
public final class ReconciledTargetHearingFormalCommandMapper implements TargetHearingFormalCommandMapper {
  ...
  private final TargetE2eRoomProposalPayloadReader payloadReader;
  ...
  public ReconciledTargetHearingFormalCommandMapper(
      ...
      TargetE2eRoomProposalPayloadReader payloadReader,
      ObjectMapper mapper) {
  ...
  private static void verifyLoaded(TargetHearingFinalizationEvidence evidence, TargetE2eRoomProposalPayloadReader.LoadedProposal loaded) {
