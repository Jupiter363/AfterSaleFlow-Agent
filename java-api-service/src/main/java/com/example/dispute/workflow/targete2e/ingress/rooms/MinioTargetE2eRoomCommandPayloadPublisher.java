...
public final class MinioTargetE2eRoomCommandPayloadPublisher {
    public static final String SCHEMA_VERSION = "target-e2e-room-command-input.v1";
    ...
    public MinioTargetE2eRoomCommandPayloadPublisher(
    ...
    public PublishedObject publishCanonical(String artifactId, String roomType, JsonNode document) {
        ...
        SnapshotRef reference = new SnapshotRef(artifactId, schemaVersion,
                "urn:target-e2e:object:" + artifactId + ":" + hash, hash, body.length);
    ...
    public PublishedObject publishCanonicalOpaque(String artifactId, String roomType, JsonNode document) {
        ...
        return new PublishedObject(new SnapshotRef(artifactId, stored.reference().schemaVersion(),
                "urn:target-e2e:object:" + artifactId, stored.reference().sha256(), stored.reference().sizeBytes()),
    ...
    public void bind(Authority authority, RoomGraphCommand command,
            PublishedObject object, TargetE2eRoomObjectIndex.Kind kind) {
        objectIndex.bindInput(authority, command, new TargetE2eRoomObjectIndex.StoredObject(
