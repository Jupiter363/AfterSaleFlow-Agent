...
/** Exact immutable target-e2e-finalization-receipt.v1 contract. */
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
public record TargetE2eFinalizationReceipt(
    ...
    public static final String SCHEMA_VERSION = "target-e2e-finalization-receipt.v1";
    private static final String ZERO_HASH = "0".repeat(64);
    private static final long MAX_SAFE_INTEGER = 9_007_199_254_740_991L;

    public TargetE2eFinalizationReceipt {
    ...
    public static TargetE2eFinalizationReceipt committed(CommitFacts facts) {
        Objects.requireNonNull(facts, "facts");
        TargetE2eFinalizationReceipt unsigned = facts.toReceipt(ZERO_HASH);
        return facts.toReceipt(TargetE2eFinalizationReceiptCodec.receiptHash(unsigned));
    }

    public void requireCanonicalHash() {
        String canonical = TargetE2eFinalizationReceiptCodec.receiptHash(this);
        if (!receiptHash.equals(canonical)) {
            throw new TargetE2eFinalizationRejectedException(
                    "TARGET_E2E_RECEIPT_HASH_MISMATCH", "receipt hash is not canonical");
        }
    }
    ...
    public record CommitFacts(
        ...
        private TargetE2eFinalizationReceipt toReceipt(String receiptHash) {
