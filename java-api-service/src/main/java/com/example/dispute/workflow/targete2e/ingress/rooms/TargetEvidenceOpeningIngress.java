...
public class TargetEvidenceOpeningIngress {
    private static final String PAYLOAD_SCHEMA = "target-e2e-evidence-opening.v1";
    ...
    private static void requireCommittedOpeningMessage(
        ...
        boolean exact = message != null
                ...
                && ("urn:target-e2e:evidence-formal-message:" + message.id())
    ...
    private PayloadRef openingPayload(
        ...
        return new PayloadRef(
                PAYLOAD_SCHEMA,
                "urn:target-e2e:evidence-opening:" + stableToken(commandId),
