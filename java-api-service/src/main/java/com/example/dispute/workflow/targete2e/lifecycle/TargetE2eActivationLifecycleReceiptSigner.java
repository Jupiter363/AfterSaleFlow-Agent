...
public final class TargetE2eActivationLifecycleReceiptSigner {

  public static final String JWT_TYPE = "target-e2e-activation-lifecycle-receipt+jwt";
  private static final String SUBJECT = "target-e2e-lifecycle-reconcile";
  ...
  public TargetE2eActivationLifecycleReceiptSigner(
  ...
  public String issue(
    ...
    receipt.put("schemaVersion", "target-e2e-activation-lifecycle-receipt.v1");
    receipt.put("executionLane", "TARGET_E2E_CANDIDATE");
