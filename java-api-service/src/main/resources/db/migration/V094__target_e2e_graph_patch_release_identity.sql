-- Preserve both predecessor target-E2E graph releases while admitting the
        ...
        and (
            (
                ...
                and graph_version in (
                    ...
                    'target-e2e-graph.2026-08-18.2',
                    'target-e2e-graph.2026-08-18.3'
                )
...
alter table case_intake_epoch_selection_binding
    ...
    add constraint ck_r15_selection_constants check (
        (
            ...
            and room_workflow_type = 'IntakeRoomWorkflow'
            and agent_key = 'DISPUTE_INTAKE_OFFICER'
            and graph_key = 'all-rooms.target-e2e.v2'
            and graph_version in (
                'target-e2e-graph.2026-08-18.1',
                'target-e2e-graph.2026-08-18.2',
                'target-e2e-graph.2026-08-18.3'
