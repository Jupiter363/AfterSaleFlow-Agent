...
import com.example.dispute.workflow.targete2e.finalization.TargetE2eIntakeOuterFinalizer.CommandCompletionWriter;
 ...
 */
public final class JdbcTargetE2eIntakeCommandCompletionWriter
        implements CommandCompletionWriter, TargetE2eCommandCompletionWriter {

    private final DataSource dataSource;
    private final TargetE2EActivationLedger activationLedger;

    public JdbcTargetE2eIntakeCommandCompletionWriter(
            DataSource dataSource, TargetE2EActivationLedger activationLedger) {
        this.dataSource = Objects.requireNonNull(dataSource, "dataSource");
        this.activationLedger = Objects.requireNonNull(activationLedger, "activationLedger");
    }

    @Override
    public void complete(ExecuteAgentRunRequest request, TargetE2eFinalizationReceipt receipt) {
