...
- [ ] 受理结果为 `NOT_ADMISSIBLE` 或 `ACCEPTED`。
...
- [ ] 受理后创建 USER 与 MERCHANT 参与方。
- [ ] 受理后开放证据书记官室。
- [ ] 所有受理案件都构建 EvidenceDossier。
- [ ] 所有受理案件都进入小法庭。
- [ ] 所有受理案件都生成非最终裁决草案。
- [ ] 所有受理案件都经过 Platform Human Review。
- [ ] 所有受理案件都经过 Tool Executor 门控。
...
- [ ] 总览、接待室、证据室、小法庭、平台终审、结果和信箱均有 Figma 节点。
- [ ] 每个关键页面有桌面、移动和角色变体。
- [ ] 视觉明亮、卡通、有轻法庭元素。
- [ ] 不使用黑金庄严风或传统电商后台布局。
