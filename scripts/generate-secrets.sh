...
replace_if_placeholder "GRAPH_DB_ENVIRONMENT_GENERATION" "graphenv-$(openssl rand -hex 12)"
replace_if_placeholder "GRAPH_DB_RESTORE_VERIFICATION_HASH" "$(openssl rand -hex 32)"
