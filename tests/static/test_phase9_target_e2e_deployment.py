...
COMPOSE_PATH = ROOT / "infra/compose/target-e2e.yml"
DEPLOY = ROOT / "infra" / "environments" / "target-e2e"
...
def test_python_to_java_graph_exchange_uses_only_the_restricted_proxy() -> None:
    ...
    assert proxy["volumes"] == [
        "./infra/environments/target-e2e/nginx/exchange.conf:/etc/nginx/conf.d/default.conf:ro"
    ]
...
def test_local_source_dirty_manifest_is_closed_complete_and_fully_hashed() -> None:
    ...
    required_paths = {
        ...
        "apps/domain-service/src/main/java/com/example/dispute/workflow/targete2e/graph/HttpTargetE2EGraphProposalClient.java",
        "apps/domain-service/src/main/java/com/example/dispute/workflow/targete2e/temporal/TargetTypedRoomCaseProcessDispatcher.java",
        ...
        "apps/domain-service/src/test/java/com/example/dispute/workflow/targete2e/graph/HttpTargetE2EGraphProposalClientTest.java",
        "apps/domain-service/src/test/java/com/example/dispute/workflow/targete2e/temporal/TargetTypedRoomCaseProcessDispatcherTest.java",
