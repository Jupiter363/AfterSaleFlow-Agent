...
- [部署](deployment/README.md)：Compose、Temporal、Langfuse 与 Production Runtime 隔离 UAT。
...
- [当前 UAT 基线](release/current-uat-baseline.md)：生产重构前的业务全链路证据及其适用边界。
- [Production Runtime 重构](release/production-runtime-refactor-2026-09-04.md)：clean break、目录映射与发布要求。
