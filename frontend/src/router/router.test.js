...
import { routeScrollBehavior } from "./index.js";
...
describe("final room-based routes", () => {
  it("starts new routes at the top while preserving browser history positions", () => {
    expect(routeScrollBehavior({}, {}, null)).toEqual({ left: 0, top: 0 });

    const savedPosition = { left: 0, top: 156 };
    expect(routeScrollBehavior({}, {}, savedPosition)).toBe(savedPosition);
  });
