...
def build_evidence_v2_graph(
    *,
    ...
    builder.add_node("assess_evidence_item", AssessEvidenceItemNode(assessor))
...
def compile_evidence_v2_graph(
    *,
    ...
    return build_evidence_v2_graph(item_assessor=item_assessor).compile(checkpointer=checkpointer)
