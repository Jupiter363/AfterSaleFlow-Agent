...
STABLE_HEARING_GRAPH_CONTRACT_ERROR_CODES = frozenset(
    {
        "HEARING_TARGET_CLOCK_INVALID",
        "HEARING_TARGET_GRAPH_STREAM_INCOMPLETE",
        "HEARING_TARGET_GRAPH_STREAM_NOT_CLOSABLE",
        "HEARING_TARGET_STREAM_EVENT_INVALID",
        "HEARING_TARGET_STREAM_METADATA_INVALID",
        "HEARING_TARGET_TERMINAL_CHECKPOINT_INVALID",
        "HEARING_TARGET_V4_FRAME_COMMIT_INVALID",
        "HEARING_TARGET_V4_FRAME_DELTA_ORDER_INVALID",
        "HEARING_TARGET_V4_FRAME_IDENTITY_INVALID",
        "HEARING_TARGET_V4_FRAME_ORDER_INVALID",
        "HEARING_TARGET_V4_FRAME_TERMINAL_INCOMPLETE",
        "HEARING_TARGET_V4_FRAME_TERMINAL_MISMATCH",
        "HEARING_TARGET_V4_FRAME_TEXT_EVENT_INVALID",
        "HEARING_TARGET_V4_LEAD_MISSING",
        "HEARING_TARGET_V4_LEAD_ORDER_INVALID",
        "HEARING_TARGET_V4_LEAD_TERMINAL_MISMATCH",
        "HEARING_TARGET_V4_MANIFEST_DUPLICATED",
        "HEARING_TARGET_V4_MANIFEST_INVALID",
        "HEARING_TARGET_V4_MANIFEST_TERMINAL_MISMATCH",
        "HEARING_TARGET_V4_STREAM_FIELD_INVALID",
        "HEARING_TARGET_V4_TERMINAL_INVALID",
        "HEARING_TARGET_VISIBLE_DELTA_INVALID",
        "HEARING_TARGET_VISIBLE_TERMINAL_MISMATCH",
    }
)
STABLE_GRAPH_CONTRACT_DIAGNOSTIC_CODES = (
    STABLE_INTAKE_GRAPH_CONTRACT_ERROR_CODES
    | STABLE_EVIDENCE_GRAPH_CONTRACT_ERROR_CODES
    | STABLE_HEARING_GRAPH_CONTRACT_ERROR_CODES
)
...
def stable_graph_contract_diagnostic_code(error: BaseException) -> str | None:
    ...
    if (
        not isinstance(error, GraphContractError)
        or len(error.args) != 1
