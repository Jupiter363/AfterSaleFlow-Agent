...
public final class ProductionAgentRunV2RetryPreparation
  ...
  public ProductionAgentRunV2RetryPreparation(
  ...
  private void persistIntake(RecoveryState state, ExecuteAgentRunRequest request) {
    ...
    ProductionGraphCommandEnvelope sealed = seal(previous.admission(), command);
  ...
  private void rebind(
      ...
      ProductionGraphCommandEnvelope nextEnvelope) {
    ProductionGraphCommandEnvelope previousEnvelope =
  ...
  private ProductionGraphCommandEnvelope seal(CommandAdmission source, RoomGraphCommand command) {
  ...
  private static Authority authority(
    ...
    return new Authority(
        "production-runtime-room-exchange-authority.v1", admission.activationId(),
