...
public final class ProductionIntakeExchangeAuthority
  ...
  private static final String AUTHORITY_SQL = """
      select material.activation_id, material.activation_manifest_hash,
        ...
        join production_runtime_room_epoch_binding room
       ...
       where activation.activation_id = :activationId
         ...
         and room.execution_lane = 'PRODUCTION'
         and room.room_type = 'INTAKE'
         and material.execution_lane = 'PRODUCTION'
  ...
  public ProductionIntakeExchangeAuthority(
  ...
  ProductionIntakeExchangeAuthority(
