alter table production_runtime_evidence_command_material
    drop constraint ck_production_runtime_evidence_material_shape;

alter table production_runtime_evidence_command_material
    add constraint ck_production_runtime_evidence_material_shape check (
        execution_lane = 'PRODUCTION' and room_type = 'EVIDENCE'
        and material_schema_version in (
            'production-runtime-evidence-command-material.v1',
            'production-runtime-evidence-command-material.v2'
        )
