...
create table production_runtime_review_non_execution_completion (
...
create index idx_target_review_non_execution_case
    on production_runtime_review_non_execution_completion(case_id, source_room_epoch);

create trigger trg_target_review_non_execution_immutable
before update or delete on production_runtime_review_non_execution_completion
...
before truncate on production_runtime_review_non_execution_completion
for each statement execute function reject_production_runtime_append_only_mutation();

revoke all on production_runtime_review_non_execution_completion from public;
