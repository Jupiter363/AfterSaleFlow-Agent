...
public final class JdbcIntakeParallelProposalStore implements ProductionIntakeProposalStore {

    private static final String SCHEMA_VERSION = "intake-turn-proposal.v2";
    private static final String URI_PREFIX = "urn:production-runtime:proposal:intake:";
