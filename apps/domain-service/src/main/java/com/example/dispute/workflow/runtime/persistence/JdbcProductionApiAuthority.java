...
import com.example.dispute.workflow.runtime.ingress.TargetIntakeActivationAuthority;
import com.example.dispute.workflow.runtime.ingress.TargetIntakeActivationGrant;
import com.example.dispute.workflow.runtime.ingress.TargetIntakeCommandAdmissionAuthority;
import com.example.dispute.workflow.runtime.ingress.TargetIntakeCommandAdmissionAuthority.AdmissionReceipt;
import com.example.dispute.workflow.runtime.ingress.TargetIntakeCommandAdmissionAuthority.AdmissionRequest;
import com.example.dispute.workflow.runtime.ingress.TargetIntakeEpochBinding;
...
public final class JdbcProductionApiAuthority
  ...
  private static final String INTAKE_EPOCH_EXECUTION_PROFILE =
      ...
      select binding.intake_room_message_execution_profile_id
        from production_runtime_room_epoch_binding binding
  ...
  public JdbcProductionApiAuthority(
  ...
  private boolean reservationExists(String activation, String tenant, String caseId) {
    ...
    try (PreparedStatement statement =
            connection.prepareStatement(
                """
                select 1 from production_runtime_case_reservation
  ...
  private static String admissionEnvelopeHash(AdmissionRequest request) {
    return sha256(
        String.join(
            "\n",
            "production-runtime-intake-admission.v1",
