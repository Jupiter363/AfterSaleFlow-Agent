...
public final class ProductionIsolationAttestationPublicKeySet {

  private static final int MAXIMUM_KEYS = 16;

  private final Map<String, ECPublicKey> keys;

  private ProductionIsolationAttestationPublicKeySet(Map<String, ECPublicKey> keys) {
    this.keys = Map.copyOf(keys);
  }

  public static ProductionIsolationAttestationPublicKeySet allowlisted(
    ...
    return new ProductionIsolationAttestationPublicKeySet(snapshot);
  }
