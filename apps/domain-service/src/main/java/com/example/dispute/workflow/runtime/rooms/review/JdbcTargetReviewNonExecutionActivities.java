...
import com.example.dispute.workflow.runtime.rooms.review.TargetReviewNonExecutionActivities.CompletionRequest;
...
import com.example.dispute.workflow.runtime.rooms.review.TargetReviewNonExecutionActivities.LoadRequest;
...
public final class JdbcTargetReviewNonExecutionActivities
  ...
  static final String RESULT_URI_PREFIX = "urn:production-runtime:review-non-execution:";
  private static final String WRITER = "production-runtime-review-non-execution";
  ...
  private CompletionResult completeInTransaction(
    ...
    try {
      ...
      activationLedger.completeCommand(
          connection,
          new ProductionActivationLedger.CommandCompletion(
  ...
  private Stored readStored(Connection connection, Authority authority, boolean updateLock)
    ...
    try (PreparedStatement statement = connection.prepareStatement("""
        select receipt_id, schema_version, tenant_surrogate, case_id,
          ...
          from production_runtime_review_non_execution_completion
  ...
  private String receiptCommandId(Connection connection, Authority authority) throws SQLException {
    try (PreparedStatement statement = connection.prepareStatement("""
        select command_id from production_runtime_review_non_execution_completion
