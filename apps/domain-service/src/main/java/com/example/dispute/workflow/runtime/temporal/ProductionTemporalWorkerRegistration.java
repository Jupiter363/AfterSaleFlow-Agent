...
/**
 * Production-only source sets contribute the dynamic typed-room dispatcher and the three additional
 ...
 */
public interface ProductionTemporalWorkerRegistration {
        ...
        public Registration {
            ...
            if (Modifier.isAbstract(caseProcessWorkflowImplementation.getModifiers())) {
                throw new IllegalArgumentException(
                        "production registration requires a concrete production-only CaseProcess dispatcher");
            }
