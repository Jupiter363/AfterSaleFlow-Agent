...
public final class ProductionAgentRunV2FinalizationFactsProvider
        implements AgentRunV2FinalizationFactsProvider {

    private final ProductionAuthorizedIntakeFinalizationSource source;

    public ProductionAgentRunV2FinalizationFactsProvider(
    ...
    private static String manifestUri(
        ...
        return "urn:production-runtime:agent-manifest:" + sha256(identity);
    }
