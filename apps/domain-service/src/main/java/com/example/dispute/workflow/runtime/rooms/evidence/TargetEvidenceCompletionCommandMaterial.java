...
public record TargetEvidenceCompletionCommandMaterial(
  ...
  public static final String SCHEMA_VERSION = "production-runtime-evidence-completion-command-material.v1";
  ...
  private static String commandHash(
    ...
    value.put("schema_version", "production-runtime-evidence-completion-command.v1");
  ...
  private static String envelopeHash(
      ...
      String commandHash) {
    var value = new TreeMap<String, Object>();
    value.put("schema_version", "production-runtime-evidence-completion-command-envelope.v1");
