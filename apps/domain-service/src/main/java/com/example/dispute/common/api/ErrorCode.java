...
public enum ErrorCode {
    ...
    TARGET_E2E_ACTIVATION_UNAVAILABLE(HttpStatus.SERVICE_UNAVAILABLE),
    TARGET_E2E_ACTIVATION_EXPIRED(HttpStatus.SERVICE_UNAVAILABLE),
    TARGET_E2E_CASE_CAPACITY_EXHAUSTED(HttpStatus.CONFLICT),
