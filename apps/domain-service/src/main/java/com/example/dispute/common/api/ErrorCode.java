...
public enum ErrorCode {
    ...
    PRODUCTION_RUNTIME_ACTIVATION_UNAVAILABLE(HttpStatus.SERVICE_UNAVAILABLE),
    PRODUCTION_RUNTIME_ACTIVATION_EXPIRED(HttpStatus.SERVICE_UNAVAILABLE),
    PRODUCTION_RUNTIME_CASE_CAPACITY_EXHAUSTED(HttpStatus.CONFLICT),
