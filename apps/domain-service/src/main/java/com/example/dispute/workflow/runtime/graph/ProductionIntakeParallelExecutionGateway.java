...
public final class ProductionIntakeParallelExecutionGateway implements AgentRunExecutionGateway {
    ...
    private final ProductionIntakeParallelAssemblyCoordinator assemblyCoordinator;
    ...
    public ProductionIntakeParallelExecutionGateway(
    ...
    public Completion execute(
        ...
        try {
            ...
            cancellationToken.throwIfCancellationRequested();
            refreshProgress(request, progress, failure);
            ProductionGraphClientException typedFailure = progress.publicOutputEmitted
                    ? ProductionGraphClientException.transport(
                            "parallel Intake execution failed after durable public output", failure)
                    : ProductionGraphClientException.remote(
    ...
    private static AgentRunExecutionException executionFailure(
            ProductionGraphClientException failure, ProgressTracker progress) {
