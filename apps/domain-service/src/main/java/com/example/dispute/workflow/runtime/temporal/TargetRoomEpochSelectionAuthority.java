...
/** Admission boundary between the production-runtime activation ledger and room epoch selection. */
public interface TargetRoomEpochSelectionAuthority {

    String PROFILE = "production-runtime";
    String EXECUTION_LANE = "PRODUCTION";
