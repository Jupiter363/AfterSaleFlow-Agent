...
public interface ProductionActivationLifecycleStore {
  ...
  static ProductionActivationLifecycleStore denyAll() {
    return new ProductionActivationLifecycleStore() {
      @Override
  ...
  record DrainCompletionProof(
    ...
    public DrainCompletionProof {
      ...
      ProductionActivationContract.sha256(proofHash, "proofHash");
      ProductionActivationContract.sha256(
          evidenceLedgerHeadHash, "evidenceLedgerHeadHash");
      ProductionActivationContract.sha256(forensicManifestHash, "forensicManifestHash");
      ProductionActivationContract.sha256(attestationKeySha256, "attestationKeySha256");
    }
