...
public final class ProductionEvidenceTurnInvocationPublisher {
    public static final String SCHEMA_VERSION = "production-runtime-evidence-turn-invocation.v2";
    ...
    public ProductionEvidenceTurnInvocationPublisher(
            MinioProductionRoomCommandPayloadPublisher publisher,
    ...
    public void bind(Authority authority, RoomGraphCommand command, Published published) {
        ...
        publisher.bind(
                ...
                ProductionRoomObjectIndex.Kind.COMMAND_INPUT);
    }
    ...
    public record Published(
            MinioProductionRoomCommandPayloadPublisher.PublishedObject invocation,
