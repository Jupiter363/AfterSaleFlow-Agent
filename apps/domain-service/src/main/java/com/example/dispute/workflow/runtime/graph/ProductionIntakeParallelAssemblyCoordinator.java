 ...
 */
public final class ProductionIntakeParallelAssemblyCoordinator {
    ...
    private static final String TARGET_PROPOSAL_SCHEMA = "production-runtime-intake-proposal.v1";
    ...
    public ProductionIntakeParallelAssemblyCoordinator(
            String activationId,
    ...
    private AssemblyResult replayResult(
        ...
        ProductionGraphCommandEnvelope storedCommand =
    ...
    private ReadyArtifact readyArtifact(
        ...
        ProductionRoomProposalSource proposalSource = proposalSource(command, output);
        ...
        ProductionGraphResultEnvelope resultEnvelope = envelopeCodec.wrapResult(
                commandEnvelope,
                output.graphResult(),
                proposalSourceNode,
        ...
        String resultRef = "urn:production-runtime:result:intake:" + graphResultHash;
    ...
    private static ProductionRoomProposalSource proposalSource(
        ...
        return new ProductionRoomProposalSource(
                ProductionRoomProposalSource.SCHEMA_VERSION,
                RoomType.INTAKE,
                new ProductionRoomProposalSource.Proposal(
                        ...
                        output.artifactUri(),
                        output.proposalSha256(),
                        ProductionRoomProposalSource.TerminalClass.COMPLETED,
                        false));
    }
