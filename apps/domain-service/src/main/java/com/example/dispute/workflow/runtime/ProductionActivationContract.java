...
final class ProductionActivationContract {

  static final String CONTRACT_VERSION = "production-runtime-activation.v1";
  static final String LANE = "PRODUCTION";
  static final String JWS_TYPE = "production-runtime-activation+jwt";
  ...
  private ProductionActivationContract() {}
  ...
  static String appProfile(String value) {
    if (!"production-runtime".equals(value)) {
      throw new IllegalArgumentException(
          "production runtime activation requires the dedicated production-runtime profile");
    }
    return value;
  }
