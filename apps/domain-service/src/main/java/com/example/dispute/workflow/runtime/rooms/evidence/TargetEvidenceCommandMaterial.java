...
public record TargetEvidenceCommandMaterial(
  ...
  public static final String SCHEMA_VERSION = "production-runtime-evidence-command-material.v2";
  public static final String LEGACY_SCHEMA_VERSION = "production-runtime-evidence-command-material.v1";
