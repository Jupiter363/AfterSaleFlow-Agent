...
public final class TargetIntakeCommandAdmissionReadiness {
    ...
    public static final String REASON_TARGET_E2E_INTAKE_PROJECTION_PENDING =
            "TARGET_E2E_INTAKE_PROJECTION_PENDING";
    ...
    public void assertDispatchAllowed(TargetIntakeActivationGrant activation, String commandId) {
        ...
        throw new BusinessException(
                ...
                Map.of(
                        "reason_code", REASON_TARGET_E2E_INTAKE_PROJECTION_PENDING,
