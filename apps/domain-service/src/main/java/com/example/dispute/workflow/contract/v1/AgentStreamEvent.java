...
public record AgentStreamEvent(
    ...
    public record Payload(
        ...
        /** Source-compatible constructor for the v3 frame payload before generation resets. */
        public Payload(
                String node,
                String field,
                String delta,
            ...
            this(node, field, delta, usage, reasonCode, resetAttemptId, finalResultRef,
                    finalResultHash, errorCode, retryable, frameId, frameSequence, frameType,
                    publicHeader, deltaIndex, publicText, durableCursor, headerSha256,
                    publicTextSha256, frameSha256, publicTextChars, null);
        }
