...
// 协作关系：主要由 「CreateDisputeRequest.toCommand」、「CaseApplicationServiceTest.command」、「CaseApplicationServiceTest.commandWithClaim」 使用。
...
public record CreateCaseCommand(
    ...
    // 上游调用：「CreateCaseCommand.CreateCaseCommand(String,String,String,String,String,String,List,String,ActorRole,ClaimResolutionSeed,RespondentAttitudeSeed)」的上游创建点包括 「CreateDisputeRequest.toCommand」、「CaseApplicationServiceTest.merchantCreatedDisputePersistsMerchantAsTheSingleIntakeInitiator」、「CaseApplicationServiceTest.command」。
    ...
    // 上游调用：「CreateCaseCommand.CreateCaseCommand(String,String,String,String,String,String,List,String)」的上游创建点包括 「CreateDisputeRequest.toCommand」、「CaseApplicationServiceTest.merchantCreatedDisputePersistsMerchantAsTheSingleIntakeInitiator」、「CaseApplicationServiceTest.command」。
    ...
    // 上游调用：「CreateCaseCommand.CreateCaseCommand(String,String,String,String,String,String,List,String,ActorRole)」的上游创建点包括 「CreateDisputeRequest.toCommand」、「CaseApplicationServiceTest.merchantCreatedDisputePersistsMerchantAsTheSingleIntakeInitiator」、「CaseApplicationServiceTest.command」。
