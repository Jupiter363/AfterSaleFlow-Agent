...
final class ProductionGraphTestFixtures {
  ...
  private ProductionGraphTestFixtures() {}

  static ProductionGraphEnvelopeCodec codec() {
    return new ProductionGraphEnvelopeCodec(MAPPER, V1_CODEC);
  }
  ...
  static JsonNode proposalSource() {
    ...
    proposal.put("schema_version", "production-runtime-intake-proposal.v1");
    ...
    proposal.put("payload_ref", "urn:production-runtime:proposal:intake:001");
    proposal.put("payload_hash", "1".repeat(64));
    proposal.put("terminal_class", "COMPLETED");
    proposal.put("formal_authority", false);
    ObjectNode source = MAPPER.createObjectNode();
    source.put("schema_version", ProductionRoomProposalSource.SCHEMA_VERSION);
