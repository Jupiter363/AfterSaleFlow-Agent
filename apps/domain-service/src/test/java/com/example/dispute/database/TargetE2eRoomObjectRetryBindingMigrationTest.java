...
class TargetE2eRoomObjectRetryBindingMigrationTest {
    ...
    private static final Path V049 = Path.of(
            "src", "main", "resources", "db", "migration",
            "V049__target_e2e_intake_command_material.sql");
    ...
    void preservesEveryHistoricalIntakeAdmissionAndAuthorityBinding() throws Exception {
        ...
        assertThat(function)
                .contains("from target_e2e_command_admission")
    ...
    private static String intakeGuard() throws Exception {
        String sql = Files.readString(MIGRATION)
                ...
                .replaceAll("\\s+", " ")
                .trim();
        String start = "create or replace function enforce_target_e2e_intake_command_material()";
