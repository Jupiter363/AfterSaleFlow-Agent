...
PRODUCTION_RUNTIME_EVIDENCE_CHECKPOINT_SCHEMA_VERSION = PRODUCTION_RUNTIME_CHECKPOINT_SCHEMA_VERSION
PRODUCTION_RUNTIME_EVIDENCE_OUTPUT_SCHEMA_VERSION = PRODUCTION_RUNTIME_OUTPUT_SCHEMA_VERSION
PRODUCTION_RUNTIME_EVIDENCE_PROPOSAL_SCHEMA_VERSION = "production-runtime-evidence-proposal.v1"
PRODUCTION_RUNTIME_ROOM_PROPOSAL_SOURCE_SCHEMA_VERSION = "production-runtime-room-proposal-source.v2"
...
class TargetEvidenceGatewayContext:
    ...
    def from_shared_execution(cls, execution: Any) -> TargetEvidenceGatewayContext:
        ...
        if (
            lane != PRODUCTION_RUNTIME_EXECUTION_LANE
    ...
    def _require_exact_command_binding(
        ...
        *,
        ...
        required = (
            ...
            PRODUCTION_RUNTIME_GRAPH_KEY,
            PRODUCTION_RUNTIME_GRAPH_VERSION,
            PRODUCTION_RUNTIME_EVIDENCE_CHECKPOINT_SCHEMA_VERSION,
            PRODUCTION_RUNTIME_EVIDENCE_OUTPUT_SCHEMA_VERSION,
        )
        persisted = (
    ...
    def admit(
        ...
        *,
        ...
        request = EvidenceAdmissionRequest(
            ...
            registry_output_schema_version=PRODUCTION_RUNTIME_EVIDENCE_OUTPUT_SCHEMA_VERSION,
...
class TargetEvidenceGraphProvider:
    ...
    checkpoint_schema_version = PRODUCTION_RUNTIME_EVIDENCE_CHECKPOINT_SCHEMA_VERSION
    output_schema_version = PRODUCTION_RUNTIME_EVIDENCE_OUTPUT_SCHEMA_VERSION
    ...
    async def _prepare_runtime(
        ...
        return build_evidence_runtime_bundle(
            ...
            fence=plan.gateway.graph_lease_fence,
            runtime_mode=PRODUCTION_RUNTIME_EXECUTION_LANE,
        )
    ...
    async def _store_proposal(
        ...
        if (
            payload.get("execution_scope") != PRODUCTION_RUNTIME_EXECUTION_LANE
        ...
        proposal: JsonObject = {
            "schema_version": PRODUCTION_RUNTIME_EVIDENCE_PROPOSAL_SCHEMA_VERSION,
        ...
        source: JsonObject = {
            "schema_version": PRODUCTION_RUNTIME_ROOM_PROPOSAL_SOURCE_SCHEMA_VERSION,
            "room_type": "EVIDENCE",
            "proposal": proposal,
        }
...
def _target_proposal_source(value: JsonObject) -> Any:
    try:
        source = ProductionRoomProposalSource.model_validate(value)
...
def _require_proposal_ref(value: Any) -> None:
    if (
        ...
        or not value.startswith("urn:production-runtime:proposal:")
        or len(value) > 512
    ):
...
__all__ = [
    "PRODUCTION_RUNTIME_EVIDENCE_CHECKPOINT_SCHEMA_VERSION",
    "PRODUCTION_RUNTIME_EVIDENCE_OUTPUT_SCHEMA_VERSION",
    "PRODUCTION_RUNTIME_EVIDENCE_PROPOSAL_SCHEMA_VERSION",
    "PRODUCTION_RUNTIME_EXECUTION_LANE",
    "PRODUCTION_RUNTIME_ROOM_PROPOSAL_SOURCE_SCHEMA_VERSION",
    "TargetEvidenceExecutionPlan",
    "TargetEvidenceExecutionResult",
